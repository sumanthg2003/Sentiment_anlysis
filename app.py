...
def load_model_and_vectorizer():
    # Load the trained model, using 'trained_model.sav' as per your notebook
...
def main():
    ...
    # Handle potential FileNotFoundError for model/vectorizer gracefully
    try:
        model, vectorizer = load_model_and_vectorizer()
    except FileNotFoundError:
        st.error("Error: Model (trained_model.sav) or Vectorizer (vectorizer.pkl) files not found.")
        st.markdown("Please ensure you have run your Jupyter notebook to create and save these files in the same directory as this `app.py` file.")
